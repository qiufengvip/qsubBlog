...
<template>
  <el-container>
    ...
    <el-main>
      <div class="top">
        <div class="top-img" :style={background:img}> {{title}}</div>
        <div class="top-label">
          <div class="top-label-item">
            <svg t="1643898385324" class="icon" viewBox="0 0 1024 1024" version="1.1"
              ...
              <path
                  ...
                  p-id="2062" fill="#bfbfbf"></path>
            </svg>
            相关标签
          </div>
          <div v-for="item in label" class="top-label-item">
            {{ item }}
          </div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      img: "url(https://media.mybj123.com/wp-content/uploads/2021/07/1627010920-d0c57a75e4fbb30.jpg)",
      title: "前端",
      label: [" 相关标签", "3D相册", "404", "404页面", ":nth-child(n)"]
